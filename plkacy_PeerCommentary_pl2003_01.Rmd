...
```
#There was a minor error in your code with str_split(barnacle," "). Otherwise, the code was concise and easy to follow. 
...
Primates
```
#I also did something similar with my challenge 4 code, but adding comments will be helpful! 
***
...
str(m3_df)
```
#Overall, your code completed all the challenges from module 4. For challenge 3, you used tesseract [] which showed me another way to construct arrays! Your comments for each challege was also very helpful and organized. 
